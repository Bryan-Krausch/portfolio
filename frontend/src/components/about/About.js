            ...
            <div className="max-w-[1100px] lg:flex lg:flex-col lg:justify-center h-full mx-auto overflow-y-scroll md:overflow-y-hidden relative">
                ...
                <div className="w-full flex flex-col lg:flex-row justify-start items-center lg:items-start lg:overflow-hidden lg:space-y-0 lg:space-x-[50px] px-6 relative ">
                    ...
                    <div className="text-sm w-full md:text-base lg:text-lg lg:w-[60%] lg:h-full text-greyText lg:pr-10 space-y-4 md:space-y-6 lg:space-y-8 animate-revealPresentationText animation-delay-500 opacity-0">
                        ...
                        <p className="leading-6 md:leading-8 lg:leading-10 ">Bonjour, je m'appelle <strong className="text-lightPurple">Krausch Bryan</strong> j'ai 20 ans. J'ai commencé le développement en 2018 cela fait maintenant <strong className="text-lightPurple">quatre ans que je développe</strong> diverses choses.
                        J'ai d'abord commencé par apprendre le développement par moi-même puis j'ai continué avec mes études. Je suis actuellement en deuxième année de <strong className="text-lightPurple">BTS SIO option SLAM</strong>.
                         ...
                         <p className="leading-6 md:leading-8 lg:leading-10">Dans le cadre de mes études, j'ai effectué <strong className="text-lightPurple">deux stages</strong>. Le premier était la création d'une boutique en ligne via le <strong className="text-lightPurple">CMS Shopify</strong>.
                    ...
                    <div className="w-[70%] lg:w-[30%] mx-auto pt-[30px] max-w-[300px]  relative pb-10">
                        <div className=' relative opacity-0 lg:before:absolute lg:before:top-[20px] lg:before:left-[20px] lg:before:border-[2px] lg:before:rounded lg:before:border-lightPurple lg:before:z-[1] lg:before:block lg:before:w-full lg:before:h-full animate-revealPrensentaionImage animation-delay-1000 group'> 
